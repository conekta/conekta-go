...
------------ | ------------- | ------------- | -------------
**Charges** | Pointer to [**[]ChargeRequest**](ChargeRequest.md) | List of [charges](https://developers.conekta.com/v2.3.0/reference/orderscreatecharge) that are applied to the order | [optional] 
...
**LineItems** | [**[]Product**](Product.md) | List of [products](https://developers.conekta.com/v2.3.0/reference/orderscreateproduct) that are sold in the order. You must have at least one product. | 
