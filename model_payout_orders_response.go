...
// checks if the PayoutOrdersResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayoutOrdersResponse{}

// PayoutOrdersResponse struct for PayoutOrdersResponse
...
// SetData gets a reference to the given []PayoutOrderResponse and assigns it to the Data field.
...
func (o PayoutOrdersResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PayoutOrdersResponse) UnmarshalJSON(data []byte) (err error) {
...
type NullablePayoutOrdersResponse struct {
	value *PayoutOrdersResponse
	isSet bool
}

func (v NullablePayoutOrdersResponse) Get() *PayoutOrdersResponse {
	return v.value
}

func (v *NullablePayoutOrdersResponse) Set(val *PayoutOrdersResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePayoutOrdersResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePayoutOrdersResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayoutOrdersResponse(val *PayoutOrdersResponse) *NullablePayoutOrdersResponse {
	return &NullablePayoutOrdersResponse{value: val, isSet: true}
}

func (v NullablePayoutOrdersResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayoutOrdersResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
