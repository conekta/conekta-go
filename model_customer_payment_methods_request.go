...
// PaymentMethodTokenRequestAsCustomerPaymentMethodsRequest is a convenience function that returns PaymentMethodTokenRequest wrapped in CustomerPaymentMethodsRequest
func PaymentMethodTokenRequestAsCustomerPaymentMethodsRequest(v *PaymentMethodTokenRequest) CustomerPaymentMethodsRequest {
	return CustomerPaymentMethodsRequest{
...
func (dst *CustomerPaymentMethodsRequest) UnmarshalJSON(data []byte) error {
	...
	if match > 1 { // more than 1 match
        ...
        if err != nil {
		   return fmt.Errorf("data failed to match schemas in oneOf(CustomerPaymentMethodsRequest): %v", err)
        } else {
