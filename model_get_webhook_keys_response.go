...
type _GetWebhookKeysResponse GetWebhookKeysResponse
...
func (o *GetWebhookKeysResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetWebhookKeysResponse := _GetWebhookKeysResponse{}

	err = json.Unmarshal(bytes, &varGetWebhookKeysResponse)

	if err != nil {
		return err
	}

	*o = GetWebhookKeysResponse(varGetWebhookKeysResponse)
