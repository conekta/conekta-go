...
type _CreateCustomerFiscalEntitiesResponseAllOf CreateCustomerFiscalEntitiesResponseAllOf
...
func (o *CreateCustomerFiscalEntitiesResponseAllOf) UnmarshalJSON(bytes []byte) (err error) {
	...
	varCreateCustomerFiscalEntitiesResponseAllOf := _CreateCustomerFiscalEntitiesResponseAllOf{}

	err = json.Unmarshal(bytes, &varCreateCustomerFiscalEntitiesResponseAllOf)

	if err != nil {
		return err
	}

	*o = CreateCustomerFiscalEntitiesResponseAllOf(varCreateCustomerFiscalEntitiesResponseAllOf)
