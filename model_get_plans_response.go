...
type _GetPlansResponse GetPlansResponse
...
func (o *GetPlansResponse) UnmarshalJSON(bytes []byte) (err error) {
	...
	varGetPlansResponse := _GetPlansResponse{}

	err = json.Unmarshal(bytes, &varGetPlansResponse)

	if err != nil {
		return err
	}

	*o = GetPlansResponse(varGetPlansResponse)
