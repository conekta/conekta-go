...
func main() {
	...
	createCustomerPaymentMethodsRequest := openapiclient.CreateCustomerPaymentMethods_request{PaymentMethodCashRequest: openapiclient.NewPaymentMethodCashRequest("card | cash | spei")} // CreateCustomerPaymentMethodsRequest | requested field for customer payment methods
