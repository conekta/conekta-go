...
type _TransferDestinationResponse TransferDestinationResponse
...
func (o *TransferDestinationResponse) UnmarshalJSON(data []byte) (err error) {
	varTransferDestinationResponse := _TransferDestinationResponse{}

	err = json.Unmarshal(data, &varTransferDestinationResponse)

	if err != nil {
		return err
	}

	*o = TransferDestinationResponse(varTransferDestinationResponse)
