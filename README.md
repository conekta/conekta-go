...
------------ | ------------- | ------------- | -------------
*BlacklistApi* | [**CreateNewBlacklistRule**](docs/BlacklistApi.md#createnewblacklistrule) | **Post** /antifraud/blacklists | Create a blacklisted rule
*BlacklistApi* | [**DeleteBlacklistRule**](docs/BlacklistApi.md#deleteblacklistrule) | **Delete** /antifraud/blacklists | Delete a blacklisted rule
*BlacklistApi* | [**GetBlacklist**](docs/BlacklistApi.md#getblacklist) | **Get** /antifraud/blacklists | Get a list of blacklisted rules
...
*WhitelistsApi* | [**CreateNewRuleWhitelist**](docs/WhitelistsApi.md#createnewrulewhitelist) | **Post** /antifraud/whitelists | Create a whitelisted rule
*WhitelistsApi* | [**DeleteRuleWhitelist**](docs/WhitelistsApi.md#deleterulewhitelist) | **Delete** /antifraud/whitelists | Delete a whitelisted rule
*WhitelistsApi* | [**GetWhiteList**](docs/WhitelistsApi.md#getwhitelist) | **Get** /antifraud/whitelists | Get a list of whitelisted rules
...
## Documentation For Models
 ...
 - [ConsumerPaymentMethodsRequest](docs/ConsumerPaymentMethodsRequest.md)
 ...
 - [RiskRulesListDataInner](docs/RiskRulesListDataInner.md)
