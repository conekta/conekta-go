...
type _BlacklistRuleResponse BlacklistRuleResponse
...
func (o *BlacklistRuleResponse) UnmarshalJSON(data []byte) (err error) {
	varBlacklistRuleResponse := _BlacklistRuleResponse{}

	err = json.Unmarshal(data, &varBlacklistRuleResponse)

	if err != nil {
		return err
	}

	*o = BlacklistRuleResponse(varBlacklistRuleResponse)
