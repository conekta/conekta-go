...
func main() {
	...
	companyDocumentRequest := *openapiclient.NewCompanyDocumentRequest("id_legal_representative", "application/pdf", "example_document.pdf", string([B@3460165f)) // CompanyDocumentRequest | Document information to update.
	acceptLanguage := "es" // string | Use for knowing which language to use (optional) (default to "es")
...
func main() {
	companyId := "6827206b1ec60400015eb09a" // string | The unique identifier of the company.
	companyDocumentRequest := *openapiclient.NewCompanyDocumentRequest("id_legal_representative", "application/pdf", "example_document.pdf", string([B@3460165f)) // CompanyDocumentRequest | Document information to upload.
	acceptLanguage := "es" // string | Use for knowing which language to use (optional) (default to "es")
