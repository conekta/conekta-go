...
type TokenResponse struct {
	// Deprecated
	Checkout *TokenResponseCheckout `json:"checkout,omitempty"`
...
// SetCheckout gets a reference to the given TokenResponseCheckout and assigns it to the Checkout field.
// Deprecated
