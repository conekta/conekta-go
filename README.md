...
[![Go Reference](https://pkg.go.dev/badge/github.com/conekta/conekta-go/v7.svg)](https://pkg.go.dev/github.com/conekta/conekta-go/v7)
...
```
go get -u github.com/conekta/conekta-go/v7
```
## Using the library
